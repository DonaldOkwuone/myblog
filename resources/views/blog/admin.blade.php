      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="http://getbootstrap.com/examples/dashboard/#">All Post</a></li>
            <li><a href="http://getbootstrap.com/examples/dashboard/#">All Users</a></li>
            <li><a href="http://getbootstrap.com/examples/dashboard/#">All Categories</a></li>
          </ul>
